...
When the user "Submit" or press "Done" or in a word "Un-focus" the keyboard, this function will be called by returning the new edited text String. Please see the **Example** section for better understanding. 
- **verticalController** accepts a **ScrollController**. Which is basically the controller of the vertical scroll widget.
